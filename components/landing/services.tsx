  ...
  return (
    <section id="servicos" className="py-24 sm:py-32 relative" ref={ref}>
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-0 w-80 h-80 bg-secondary/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <p className="text-xs tracking-widest uppercase text-primary font-sans font-semibold mb-4">O que fazemos</p>
