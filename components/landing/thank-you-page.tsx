...
export function ThankYouPage() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center py-16 relative overflow-hidden bg-background">
      {/* Decorative blobs */}
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto px-6">
        {/* Logo */}
        <div className="mb-10">
          <Logo variant="horizontal" color="color" size="md" linkTo="/" />
        </div>
        ...
        >
          ...
          <h1 className="font-display text-4xl sm:text-5xl font-normal text-foreground">
            Obrigado!
          </h1>
